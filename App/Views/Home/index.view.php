            ...
            <div class="col-lg-8 fade-in">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-center gap-3">
                    <?php if (!$user->isLoggedIn()) { ?>
                        <a href="<?= $link->url('auth.login') ?>" class="btn btn-primary btn-lg px-sm-5 w-100 w-sm-auto">Get Started</a>
                        <a href="<?= $link->url('auth.register') ?>" class="btn btn-outline-light btn-lg px-sm-5 w-100 w-sm-auto">Join Now</a>
                    <?php } else { ?>
                        <a href="<?= $link->url('lead.index') ?>" class="btn btn-primary btn-lg px-sm-5 w-100 w-sm-auto">Go to Dashboard</a>
                    <?php } ?>
                </div>
            </div>
        </div>
